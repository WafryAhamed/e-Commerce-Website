...
export function ProductDetails() {
  ...
  const handleBuyNow = () => {
    ...
    // In real app, add to cart and redirect to checkout
  };
  if (!product)
  return (
    <div className="p-20 text-center text-primary">Product not found</div>);
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <button
              ...
              className={`aspect-square rounded-xl overflow-hidden border-2 transition-colors ${activeImage === idx ? 'border-accent-gold' : 'border-transparent hover:border-subtle'}`}>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-4 mb-6">
            <div className="flex items-center gap-1">
              ...
              <Star
                key={i}
                className={`w-5 h-5 ${i < Math.floor(product.rating) ? 'fill-accent-gold text-accent-gold' : 'text-subtle'}`} />
